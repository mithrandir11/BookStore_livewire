                            ...
                            <div class="py-3">
                                <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                    ...
                                    <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                        <a href="{{route('ShowBook', [$book->id, $book->slug])}}" class="text-sm lg:text-base font-medium text-gray-900  ">{{ $book->title }}</a>

                                        <div class="flex items-center gap-x-8">
                                        <button type="button" class="inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-900  ">
                                        ...
                                        {{-- <button @click="removeFromCart(product)" type="button" class="inline-flex items-center text-sm font-medium text-red-600  ">
                                            <svg class="me-1.5 h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
