<div>
    <div class="self-end justify-self-start lg:justify-self-end mt-4 ">
        ...
        <div class=" flex items-center gap-x-6 rounded-lg border   px-5 py-2.5  ">
            ...
            <button wire:click="removeFromCart" type="button">
        ...
        @else
        <button wire:click="addToCart" type="button" class="flex items-center gap-x-3 rounded-lg bg-primary-700 px-5 py-2.5 text-sm  text-white duration-200 hover:bg-primary-800 focus:outline-none">
            افزودن به سبد
